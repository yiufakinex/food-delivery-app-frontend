...
const UsernameMenu = () => {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="flex items-center px-3 font-bold hover:text-red-400 gap-2">
            ...
            <DropdownMenuContent>
                ...
                <Separator />
                <DropdownMenuItem>
                    <Button onClick={() => logout()} className="flex flex-1 font-bold bg-red-400">
                        Log Out
                    </Button>
                </DropdownMenuItem>
            </DropdownMenuContent>
